...
class LabRequestControllerTest {
    ...
    /**
     * Testing assignForLabTest with valid test request ID
    ...
    /**
     * Testing assignForLabTest with invalid test request ID
    ...
    /**
     * Testing updateLabTest with valid test request ID
     * It should update the request status and update test request details
     */
    @Test
    @WithUserDetails(value = "tester")
    ...
    /**
     * Testing updateLabTest with invalid test request ID
    ...
    /**
     * Testing updateLabTest with invalid empty status
     * It should throw an exception
     */
    @Test
    @WithUserDetails(value = "tester")
    ...
    /**
     * Testing getCreateLabResult
     * It should set the values of Lab results
     */
